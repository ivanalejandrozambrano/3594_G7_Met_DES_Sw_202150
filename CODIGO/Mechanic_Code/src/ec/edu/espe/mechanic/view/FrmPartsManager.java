...
public class FrmPartsManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Actualizar Repuestos");
        ...
        if (txtDataToDelete.getText().isEmpty()) {
            ...
            switch (selection) {
                case 0:
                    ...
                    deleteCars(mongo, "Mechanic", "Parts", txtDataToDelete.getText());
            ...
            switch (selection) {
                case 0:
                    JOptionPane.showMessageDialog(null, "Information was updating", txtDataToUpdate.getText() + "Updated",
                            JOptionPane.INFORMATION_MESSAGE);
                    updateCars(mongo, "Mechanic", "Parts", txtDataToUpdate.getText(), txtNewData.getText(), cmbField.getSelectedItem().toString());
